...
(function () {
  ...
  if (typeof marked === "undefined") {
    console.error(
      "Marked library is not loaded. Markdown formatting will not work.",
    );
  }
  ...
  const ShopAIChat = {
    ...
    Message: {
      ...
      add: function (text, sender, messagesContainer) {
        ...
        // Store raw text for assistant messages
        if (sender === "assistant") {
          messageElement.dataset.rawText = text;
          // Process markdown immediately for assistant messages
    ...
    Formatting: {
      ...
      formatMessageContent: function (element) {
        ...
        const markdownOptions = window.shopChatConfig?.markdownOptions || {
          breaks: true,
          gfm: true,
          headerIds: false,
          mangle: false,
        ...
        let processedText = marked.parse(rawText);

        // Process special links (auth and checkout)
      ...
      handleStreamEvent: function (
        ...
        switch (data.type) {
          ...
          case "chunk":
            ...
            // Process markdown for each chunk
          ...
          case "new_message":
            // Process markdown for the completed message
            ShopAIChat.Formatting.formatMessageContent(currentMessageElement);
            ShopAIChat.UI.showTypingIndicator();
